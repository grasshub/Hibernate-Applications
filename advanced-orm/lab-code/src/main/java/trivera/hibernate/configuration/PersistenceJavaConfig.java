...
import trivera.hibernate.dao.MovieTheaterDAOImpl;
import trivera.hibernate.dao.ScreenDAO;
import trivera.hibernate.dao.ScreenDAOImpl;
...
public class PersistenceJavaConfig {
	...
	public MovieTheaterDAO movieTheaterDAO () {
		MovieTheaterDAO movieTheaterDAO = new MovieTheaterDAOImpl(hibernateTemplate());
		return movieTheaterDAO;
	}
	
	@Bean
	public ScreenDAO screenDAO() {
		ScreenDAO screenDAO = new ScreenDAOImpl(hibernateTemplate());
		return screenDAO;
	}
